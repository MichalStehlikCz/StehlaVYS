 ...
 * internal names of objects and is similar to NAME, with additional restriction
...
public class DtOptNameNm extends DtOptName {
    ...
    /**
     * Returns an {@code DtOptNameNm} with the specified optional string value.
     *
     * @param value the value to be present; might be empty optional, but should
     * not be null
     * @return an {@code DtOptName} with the value present
     * @throws NullPointerException if value is null
     */
    public static DtOptNameNm of(Optional<String> value) {
        Objects.requireNonNull(value);
        return value.isPresent() ? new DtOptNameNm(value) : empty();
    }

    /**
     * Returns an {@code DtOptNameNm} with the specified {@code DtName} non-null
     * value.
     *
     * @param value the value to be present, which must be non-null
     * @return an {@code DtOptName} with the value present
     * @throws NullPointerException if value is null
     */
    public static DtOptNameNm of(DtNameNm value) {
        Objects.requireNonNull(value);
        return new DtOptNameNm(value.getValue());
    }

    /**
     * Returns an {@code DtOptNameNm} describing the specified {@code DtNameNm}
     * value. If specified value is null, returns an empty {@code DtOptNameNm}.
     *
     * @param value the possibly-null value to describe
     * @return an {@code DtOptNameNm} with a present value if the specified
     * value is non-null, otherwise an empty {@code DtOptNameNm}
     */
    public static DtOptNameNm ofNullable(DtNameNm value) {
        return value == null ? empty() : of(value);
    }
     ...
     */
    private DtOptNameNm(String value) {
        super(value);
    }

    /**
     * Creates DtOptName from supplied value.
     *
     * @param value - string value new object will be initialised with
     */
    private DtOptNameNm(Optional<String> value) {
        super(value);
    }
