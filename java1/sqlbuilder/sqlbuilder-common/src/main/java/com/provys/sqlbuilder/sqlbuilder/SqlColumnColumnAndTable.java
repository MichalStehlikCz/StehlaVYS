 ...
 * @author stehlik
 */
class SqlColumnColumnAndTable extends SqlColumnSimple {
    
    private final SqlFromElem fromElem;
    
    public SqlColumnColumnAndTable(String column, Class<? extends Dt> type
    ...
    public SqlColumnColumnAndTable(String column, String alias
