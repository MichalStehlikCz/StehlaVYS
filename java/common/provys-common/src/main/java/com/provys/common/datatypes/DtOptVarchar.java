...
public class DtOptVarchar extends DtOptString {
     ...
     * {@code DtOptVarchar.empty()}. There is no guarantee that it is a
    ...
    /**
     * Returns an {@code DtOptVarchar} with the specified value.
     *
     * @param value the value to be present, which must be non-null
     * @return an {@code DtOptVarcar} with the value present
     * @throws NullPointerException if value is null
     */
    public static DtOptVarchar of(Optional<String> value) {
        Objects.requireNonNull(value);
        return new DtOptVarchar(value);
    }
     ...
     * @throws NullPointerException if value is null
     */
    public static DtOptVarchar of(DtVarchar value) {
        Objects.requireNonNull(value);
        return new DtOptVarchar(value.getValue());
    }
     ...
     * value is non-null, otherwise an empty {@code DtOptVarchar}
     */
    public static DtOptVarchar ofNullable(DtVarchar value) {
        return value == null ? empty() : of(value);
    }
    ...
    private DtOptVarchar() {
        super();
    }

    private DtOptVarchar(String value) {
        super(DtVarchar.validateVarchar(value));
    }

    private DtOptVarchar(Optional<String> value) {
        super(value);
        value.ifPresent(DtVarchar::validateVarchar);
    }
