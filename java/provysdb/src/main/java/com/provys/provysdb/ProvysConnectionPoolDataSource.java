...
/**
 * Datasource to be used for accesing PROVYS database. Based on Oracle Universal Connection Pool,
 * this datasource supports switching of session context to one representing user session on
 * retrieval
 *
 * @author stehlik
 */
