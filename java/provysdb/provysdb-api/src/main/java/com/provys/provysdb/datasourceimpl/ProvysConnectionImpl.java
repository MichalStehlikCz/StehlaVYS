...
public class ProvysConnectionImpl implements ProvysConnection {
    private static final Logger LOG = Logger.getLogger(ProvysConnectionImpl.class.getName());
    ...
    public ProvysStatement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        return new ProvysStatementImpl(
                conn.createStatement(resultSetType, resultSetConcurrency));
    }

    @Override
    public ProvysStatement createStatement(int resultSetType,
    ...
    public ProvysPreparedStatement prepareStatement(String sql
        ...
        return new ProvysPreparedStatementImpl(
    ...
    @Override
    public ProvysCallableStatement prepareCall(String sql, int resultSetType,
            int resultSetConcurrency) throws SQLException {
        return new ProvysCallableStatementImpl(
