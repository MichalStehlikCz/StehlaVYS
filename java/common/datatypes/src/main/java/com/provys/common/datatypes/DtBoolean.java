 ...
 * @author stehlik
 *
 * Used to store PROVYS UID values. UID domain is implemented as 38 digit NUMBER
 * in Oracle, but should be treated as not interpreted identifier and thus
 * String type has been chosen to hold value of UID in PROVYS
 */
